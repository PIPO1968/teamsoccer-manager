...
import { WeatherType } from "../utils/weatherUtils";
...
export type FieldPosition = 'defense' | 'defenseHalf' | 'midfield' | 'attackingHalf' | 'attackingThird';
...
export interface GameContext {
  ...
  lastAction: string;
  fieldPosition: FieldPosition; // Enhanced field position tracking
