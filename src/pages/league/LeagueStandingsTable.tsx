...
type LeagueTeamStats = {
  ...
  points: number;
  form: string[];
  is_bot: number; // This field is correctly typed as number
};
...
const TeamIcon = ({ team }: { team: LeagueTeamStats }) => {
  if (team.is_bot === 1) {
    return (
...
const LeagueStandingsTable = ({ teams }: LeagueStandingsTableProps) => {
